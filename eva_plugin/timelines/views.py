...
from eva_plugin.tools.timelines_builder import TimelinesBuilder
from eva_plugin.tools.timelines_loader import TimelinesLoader
...
class TimelinesView(APIView):
    ...
    logger = logging.getLogger('eva_plugin.timelines')
